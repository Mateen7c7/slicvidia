            ...
            >
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <p className="text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed">
                        Your digital presence should be your best salesperson. Get a custom roadmap to scale your business—100% free, no obligation.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full sm:w-auto px-10 py-4 bg-white text-blue-900 rounded-full font-bold text-lg hover:bg-blue-50 transition-colors shadow-xl"
                        >
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full sm:w-auto px-10 py-4 bg-transparent border-2 border-white/20 text-white rounded-full font-bold text-lg hover:border-white transition-all backdrop-blur-sm"
                        >
                            View Our Portfolio
                        </motion.button>
                    </div>
